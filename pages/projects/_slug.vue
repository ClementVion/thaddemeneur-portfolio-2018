<template lang="html">
  <section class="Project">
    ...
    <div class="Project__Header">
      ...
      <nuxt-link class="Project__HeaderAllProjects js-linkToHover" to="/allprojects">All Projects</nuxt-link>
    </div>
...
.page-enter-active .Project__Header {
  transition: ease 0.3s 0.2s;
}

.page-leave-active .Project__Header {
  transition: ease 0.3s;
}

.page-enter .Project__Header,
.page-leave-active .Project__Header{
  opacity: 0;
}
